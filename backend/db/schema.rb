...
ActiveRecord::Schema[7.1].define(version: 2025_12_13_000004) do
  ...
  add_foreign_key "leads", "users", column: "owner_id", on_delete: :cascade
  add_foreign_key "notes", "leads", on_delete: :cascade
  add_foreign_key "notes", "users", on_delete: :cascade
  add_foreign_key "tasks", "leads", on_delete: :cascade
